    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #000; color: white; border-radius: 12px; border: 2px solid #f66;">
          ...
          <h1 style=\"font-size: 24px; text-align: center; margin-bottom: 12px; color: #f66; text-transform: uppercase;\">Today's Prompt</h1>
          <div style=\"text-align: center; font-size: 16px; font-weight: bold; padding: 4px 12px; border: 2px solid #f66; display: inline-block; margin: 0 auto 30px;\">
            ${dailyPrompt}
          </div>

          <h1 style=\"font-size: 24px; text-align: center; margin-bottom: 12px; color: #f66; text-transform: uppercase;\">Yesterday's Winning Lineup</h1>
          <div style=\"text-align: center; font-size: 16px; font-weight: bold; padding: 4px 12px; border: 2px solid #f66; display: inline-block; margin: 0 auto 30px;\">
            ${yesterdayPrompt}
          </div>"font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #000; color: white; border-radius: 12px; border: 2px solid #f66;">
          <div style="text-align: center; margin-bottom: 20px;">
            <img src="https://best-concert-ever.vercel.app/emailheader.png" alt="Best Concert Ever logo" style="width: 100%; max-width: 600px; height: auto; display: block;" />
          </div>
          <h1 style="font-size: 24px; text-align: center; margin-bottom: 12px; color: #f66; text-transform: uppercase;">Yesterday's Winning Lineup</h1>
          ...
          <div style="display: flex; flex-direction: column; gap: 30px; align-items: center;">
            <div>
              <img src="${headlinerImg}" alt="${headliner}" style="width: 120px; height: 120px; border-radius: 50%; border: 3px solid #f66;" />
              <div style="margin-top: 8px; font-size: 16px; font-weight: bold;">${headliner}</div>
            </div>
            <div>
              <img src="${openerImg}" alt="${opener}" style="width: 120px; height: 120px; border-radius: 50%; border: 3px solid #f66;" />
              <div style="margin-top: 8px; font-size: 16px; font-weight: bold;">${opener}</div>
            </div>
            <div>
              <img src="${secondOpenerImg}" alt="${secondOpener}" style="width: 120px; height: 120px; border-radius: 50%; border: 3px solid #f66;" />
              <div style="margin-top: 8px; font-size: 16px; font-weight: bold;">${secondOpener}</div>
            </div>
          </div>
