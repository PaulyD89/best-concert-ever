...
{showHowToPlay && (
    ...
    >
        <div className="absolute -top-14 left-1/2 transform -translate-x-1/2 w-36 h-36 bg-white rounded-full border-4 border-black shadow-lg flex items-center justify-center overflow-hidden">
        <img src="/logo.png"
  ...
  />
        ...
        <div className="mt-12 mb-4 text-base font-extrabold uppercase tracking-widest text-black inline-block px-4 py-1 border-2 border-black rotate-[-2deg] bg-white shadow-md font-mono">
          {dailyPrompt}
        </div>
