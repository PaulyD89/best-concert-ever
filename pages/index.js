...
{showVoteNudge && (
  <div className="fixed bottom-20 left-1/2 transform -translate-x-1/2 w-[90%] max-w-xl bg-black text-yellow-300 border-4 border-double border-yellow-500 px-6 py-5 rounded-2xl shadow-2xl z-50 animate-flicker">
