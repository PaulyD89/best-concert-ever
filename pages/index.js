          ...
          <body>
            ...
            <script>
              ...
              background.onload = function() {
                ...
                const today = new Date();
const formattedDate = String(today.getUTCMonth() + 1).padStart(2, '0') + String(today.getUTCDate()).padStart(2, '0') + today.getUTCFullYear();
const cleanedPrompt = (dailyPrompt || "").replace(/[^A-Za-z]/g, '').substring(0, 7).toUpperCase();
const barcodeCodeText = `${formattedDate}-${cleanedPrompt}`;
